...
public class WebsiteCrowlingeETVBharatMalayalam2 {
	public static void main(String[] args) throws IOException {
		String ss = "";

		Document doc = Jsoup.connect(
				"https://www.etvbharat.com/malayalam/kerala/entertainment/movie/urvashi-and-indrans-starrer-jaladhara-pumpset-since-1962-sneak-peek-out/kerala20230727124325544544122")
				.get();
