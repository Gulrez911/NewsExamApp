...
public class WebsiteCrowlingeETVBharatOdia2 {
	public static void main(String[] args) throws IOException {
		String ss = "";

		Document doc = Jsoup.connect(
				"https://www.etvbharat.com/oriya/odisha/state/bargarh/vegetable-price-rise-in-bargarh/or20230728225427627627864")
				.get();
					...
					if (ee.className().contains("text-base md:text-md")) {
						...
						for (Element p2 : p) {
							...
							if (!se.equals("")) {
								...
								if (!p2.toString().contains("ଇଟିଭି ଭାରତ")&&!p2.toString().contains("twitter")&&!p2.toString().contains("https://www.etvbharat.com/")) {
									if (ss.equals("")) {
										ss += p2.text();
