...
public class WebsiteCrowlingNews18Tamil2 {
	public static void main(String[] args) throws IOException {
		String ss = "";
		Document doc = Jsoup.connect(
				"https://tamil.news18.com/entertainment/cinema-tv-actress-sruthi-husband-arvind-sekars-last-instagram-post-left-her-fans-deeply-saddened-1094893.html"
						+ "")
				.get();
