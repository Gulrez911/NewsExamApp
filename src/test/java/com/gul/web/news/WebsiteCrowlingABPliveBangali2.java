...
public class WebsiteCrowlingABPliveBangali2 {
	public static void main(String[] args) throws IOException {
		String ss = "";
		Document doc = Jsoup.connect(
				"https://bengali.abplive.com/district/west-bengal-weather-update-rain-forecast-in-north-bengal-discomfort-due-to-humidity-in-south-bengal-990566")
				.get();
