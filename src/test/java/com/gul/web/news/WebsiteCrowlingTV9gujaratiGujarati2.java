...
public class WebsiteCrowlingTV9gujaratiGujarati2 {
	public static void main(String[] args) throws IOException {
		String ss = "";
		Document doc = Jsoup.connect(
				"https://tv9gujarati.com/mumbai/after-ncp-there-is-danger-of-rebellion-here-too-entry-of-9-ministers-of-ajit-pawar-spread-panic-in-shinde-group-795875.html")
				.get();
