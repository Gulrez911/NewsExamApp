...
public class WebsiteCrowlingeETVBharatOdia {
	public static void main(String[] args) throws IOException {

		Document doc = Jsoup.connect("https://www.etvbharat.com/oriya/odisha/entertainment/top-news").get();
							...
							if (ee3.className().contains("flex w-full justify-between")) {
								...
								for (Element ee25566 : ee255) {
									if (ee25566.className().contains(
											"rounded-md shadow  w-1/3 bg-white")) {
										...
										for (Element ee5 : ee4) {
											...
											if (ee5.className()
													.contains("text-gray-700 leading-tight")) {
