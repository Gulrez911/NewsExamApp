...
public class WebsiteCrowlingOneindiaMalayalam2 {
	public static void main(String[] args) throws IOException {
		String ss = "";
		int flag = 0;
		
		Connection connection = Jsoup.connect("https://malayalam.oneindia.com/news/india/pm-modi-set-to-meet-430-nda-mp-s-in-6-days-here-is-reason-and-benefits-of-it-396115.html?ref_medium=Desktop&ref_source=OI-ML&ref_campaign=Topic-Article&story=3");
		connection.userAgent("Mozilla/5.0");
		Document doc = connection.get();
		
//		Document doc = Jsoup.connect(
//				"https://malayalam.oneindia.com/news/india/pm-modi-set-to-meet-430-nda-mp-s-in-6-days-here-is-reason-and-benefits-of-it-396115.html?ref_medium=Desktop&ref_source=OI-ML&ref_campaign=Topic-Article&story=3")
//				.get();
