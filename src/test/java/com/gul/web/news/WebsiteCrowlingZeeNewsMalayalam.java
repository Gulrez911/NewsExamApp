...
public class WebsiteCrowlingZeeNewsMalayalam {
	public static void main(String[] args) throws IOException {

		Document doc = Jsoup.connect("https://zeenews.india.com/malayalam/crime-news").get();
...
//			System.out.println("  ..........   "+element );
			...
			if (element.className().equals("view-content")) {
				...
				for (Element ee : divChildren2) {
					if (ee.className().contains("story-list")) {
