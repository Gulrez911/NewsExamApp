...
public class WebsiteCrowlingTV9teluguTelugu {
	public static void main(String[] args) throws IOException {

		Document doc = Jsoup.connect("https://tv9telugu.com/world").get();
...
//						if (ee3.className().equals("bigDesc")) {
//							Elements p = ee.getElementsByTag("a");
//							String href = p.attr("href");
//							System.out.println(href);
//
...
// 
//						}
//						if (ee3.className().equals("imgThumb")) {
