...
public class WebsiteCrowlingOneindiaTamil2 {
	public static void main(String[] args) throws IOException {
		String ss = "";
		int flag = 0;
		Connection connection = Jsoup.connect("https://tamil.oneindia.com/news/india/4-killed-today-in-west-bengal-in-local-body-election-violence-520209.html");
		connection.userAgent("Mozilla/5.0");
		Document doc = connection.get();
//		Document doc = Jsoup.connect(
//				"https://tamil.oneindia.com/news/india/4-killed-today-in-west-bengal-in-local-body-election-violence-520209.html")
//				.get();
