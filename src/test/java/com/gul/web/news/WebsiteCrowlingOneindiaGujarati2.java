...
public class WebsiteCrowlingOneindiaGujarati2 {
	public static void main(String[] args) throws IOException {
		String ss = "";

		int flag = 0;
		
		Connection connection = Jsoup.connect("https://gujarati.oneindia.com/movies/bollywood/gossips/the-actress-of-the-film-the-kerala-story-was-hospitalized-110015.html");
		connection.userAgent("Mozilla/5.0");
		Document doc = connection.get();
		
//		Document doc = Jsoup.connect(
//				"https://gujarati.oneindia.com/jokes/gujarati-jokes-take-a-break-from-work-and-read-these-jokes-100507.html")
//				.get();
