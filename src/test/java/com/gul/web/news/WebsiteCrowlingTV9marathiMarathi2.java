...
public class WebsiteCrowlingTV9marathiMarathi2 {
	public static void main(String[] args) throws IOException {
		String ss = "";
		Document doc = Jsoup.connect(
				"https://www.tv9marathi.com/crime/palghar-crime-news-government-employee-tourists-drowned-in-water-980852.html")
				.get();
