...
public class WebsiteCrowlingOneindiaOdia2 {
	public static void main(String[] args) throws IOException {
		String ss = "";
		int flag = 0;
		Connection connection = Jsoup.connect("https://odia.oneindia.com/national/tomato-price-in-uttarakhand-is-rs-250-per-kg-020583.html");
		connection.userAgent("Mozilla/5.0");
		Document doc = connection.get();
//		Document doc = Jsoup.connect(
//				"https://odia.oneindia.com/national/tomato-price-in-uttarakhand-is-rs-250-per-kg-020583.html")
//				.get();
