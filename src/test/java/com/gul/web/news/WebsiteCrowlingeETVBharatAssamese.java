...
public class WebsiteCrowlingeETVBharatAssamese {
	public static void main(String[] args) throws IOException {

		Document doc = Jsoup.connect("https://www.etvbharat.com/assamese/assam/state").get();
...
//				Elements divChildren2 = element.getElementsByTag("a");
				...
				for (Element ee : divChildren2) {
					...
					if (ee.className().contains(
							"flex  justify-between px-1 pt-1 pb-1")) {
