...
<body>
	...
	<div id="page">
		...
		<form:form name="examForm" method="post" modelAttribute="exam" action="saveExam">
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="examName">Exam Name</label>
					<form:hidden path="id" />
					<form:input path="examName" name="examName" id="examName" required="true" class="form-control" />
					<!-- 					<input type="email" class="form-control" id="inputEmail4" placeholder="Email"> -->
				</div>
			</div>
			<div class="form-row">
				<div class="form-group col-md-4">
					<label for="inputState">Test Names</label>
					<form:select path="tests" required="true" id="example-multiple-selected" class="form-control" multiple="multiple">
						<form:options items="${tests}" itemValue="testName" itemLabel="testName" />
					</form:select>
