...
<div id="pagetop" class="w3-bar w3-card-2 notranslate" style="position: relative;z-index: 4;font-size: 18px;background-color: white;color:#282A35;padding-left:12px;padding-right:16px;font-family: 'Source Sans Pro', sans-serif;">
...
<nav id="nav_tutorials" class="w3-hide-small" style="position:absolute;background-color:#282A35;color:white;padding-bottom:60px;">
 ...
 <br class="hidesm">
			...
			<nav id="nav_references" class="w3-hide-small"
				style="position: absolute; background-color: #282A35; color: white; padding-bottom: 60px;">
				<div class="w3-content" style="max-width: 1100px; font-size: 18px">
					...
					<div class="w3-row-padding w3-bar-block">
						...
						<div class="w3-col l3 m6">
							...
							<a class="w3-bar-item w3-button" href='/tags/default.asp'>HTML Tag Reference</a> <a
								class="w3-bar-item w3-button" href='/tags/ref_html_browsersupport.asp'>HTML Browser
								Support</a> <a class="w3-bar-item w3-button" href='/tags/ref_eventattributes.asp'>HTML Event
								Reference</a> <a class="w3-bar-item w3-button" href='/colors/default.asp'>HTML Color
								Reference</a> <a class="w3-bar-item w3-button" href='/tags/ref_attributes.asp'>HTML
								Attribute Reference</a> <a class="w3-bar-item w3-button" href='/tags/ref_canvas.asp'>HTML
								Canvas Reference</a> <a class="w3-bar-item w3-button" href='/graphics/svg_reference.asp'>HTML
								SVG Reference</a> <a class="w3-bar-item w3-button" href='/graphics/google_maps_reference.asp'>Google
								Maps Reference</a>
							<h3 class="w3-margin-top">CSS</h3>
							<a class="w3-bar-item w3-button" href='/cssref/default.asp'>CSS Reference</a> <a
								class="w3-bar-item w3-button" href='/cssref/css3_browsersupport.asp'>CSS Browser Support</a>
							<a class="w3-bar-item w3-button" href='/cssref/css_selectors.asp'>CSS Selector Reference</a>
							<a class="w3-bar-item w3-button" href='/bootstrap/bootstrap_ref_all_classes.asp'>Bootstrap
								3 Reference</a> <a class="w3-bar-item w3-button"
								href='/bootstrap4/bootstrap_ref_all_classes.asp'>Bootstrap 4 Reference</a> <a
								class="w3-bar-item w3-button" href='/w3css/w3css_references.asp'>W3.CSS Reference</a> <a
								class="w3-bar-item w3-button" href='/icons/icons_reference.asp'>Icon Reference</a> <a
								class="w3-bar-item w3-button" href='/sass/sass_functions_string.php'>Sass Reference</a>
						</div>
						<div class="w3-col l3 m6">
							<h3 class="w3-margin-top">JavaScript</h3>
							<a class="w3-bar-item w3-button" href='/jsref/default.asp'>JavaScript Reference</a> <a
								class="w3-bar-item w3-button" href='/jsref/default.asp'>HTML DOM Reference</a> <a
								class="w3-bar-item w3-button" href='/jquery/jquery_ref_overview.asp'>jQuery Reference</a> <a
								class="w3-bar-item w3-button" href='/angular/angular_ref_directives.asp'>AngularJS
								Reference</a> <a class="w3-bar-item w3-button" href="/appml/appml_reference.asp">AppML
								Reference</a> <a class="w3-bar-item w3-button" href="/w3js/w3js_references.asp">W3.JS
								Reference</a>
							<h3 class="w3-margin-top">Programming</h3>
							<a class="w3-bar-item w3-button" href='/python/python_reference.asp'>Python Reference</a> <a
								class="w3-bar-item w3-button" href='/java/java_ref_keywords.asp'>Java Reference</a>
						</div>
						<div class="w3-col l3 m6">
							<h3 class="w3-margin-top">Server Side</h3>
							<a class="w3-bar-item w3-button" href='/sql/sql_ref_keywords.asp'>SQL Reference</a> <a
								class="w3-bar-item w3-button" href='/mysql/mysql_ref_functions.asp'>MySQL Reference</a> <a
								class="w3-bar-item w3-button" href='/php/php_ref_overview.asp'>PHP Reference</a> <a
								class="w3-bar-item w3-button" href='/asp/asp_ref_response.asp'>ASP Reference</a>
							<h3 class="w3-margin-top">XML</h3>
							<a class="w3-bar-item w3-button" href='/xml/dom_nodetype.asp'>XML DOM Reference</a> <a
								class="w3-bar-item w3-button" href='/xml/dom_http.asp'>XML Http Reference</a> <a
								class="w3-bar-item w3-button" href='/xml/xsl_elementref.asp'>XSLT Reference</a> <a
								class="w3-bar-item w3-button" href='/xml/schema_elements_ref.asp'>XML Schema Reference</a>
						</div>
						<div class="w3-col l3 m6">
							<h3 class="w3-margin-top">Character Sets</h3>
							<a class="w3-bar-item w3-button" href='/charsets/default.asp'>HTML Character Sets</a> <a
								class="w3-bar-item w3-button" href='/charsets/ref_html_ascii.asp'>HTML ASCII</a> <a
								class="w3-bar-item w3-button" href='/charsets/ref_html_ansi.asp'>HTML ANSI</a> <a
								class="w3-bar-item w3-button" href='/charsets/ref_html_ansi.asp'>HTML Windows-1252</a> <a
								class="w3-bar-item w3-button" href='/charsets/ref_html_8859.asp'>HTML ISO-8859-1</a> <a
								class="w3-bar-item w3-button" href='/charsets/ref_html_symbols.asp'>HTML Symbols</a> <a
								class="w3-bar-item w3-button" href='/charsets/ref_html_utf8.asp'>HTML UTF-8</a>
						</div>
					</div>
					<br class="hidesm">
				</div>
...
<a target="_top" href="index.php">Kotlin HOME</a>
<a target="_top" href="kotlin_intro.php">Kotlin Intro</a>
<a target="_top" href="kotlin_getstarted.php">Kotlin Get Started</a>
<a target="_top" href="kotlin_syntax.php">Kotlin Syntax</a>
<a target="_top" href="kotlin_output.php">Kotlin Output</a>
<a target="_top" href="kotlin_comments.php">Kotlin Comments</a>
<a target="_top" href="kotlin_variables.php">Kotlin Variables</a>
<a target="_top" href="kotlin_data_types.php">Kotlin Data Types</a>
<a target="_top" href="kotlin_operators.php">Kotlin Operators</a>
<a target="_top" href="kotlin_strings.php">Kotlin Strings</a>
<a target="_top" href="kotlin_booleans.php">Kotlin Booleans</a>
<a target="_top" href="kotlin_conditions.php">Kotlin If...Else</a>
<a target="_top" href="kotlin_when.php">Kotlin When</a>
<a target="_top" href="kotlin_while_loop.php">Kotlin While Loop</a>
<a target="_top" href="kotlin_break.php">Kotlin Break/Continue</a>
<a target="_top" href="kotlin_arrays.php">Kotlin Arrays</a>
<a target="_top" href="kotlin_for_loop.php">Kotlin For Loop</a>
<a target="_top" href="kotlin_ranges.php">Kotlin Ranges</a>
<a target="_top" href="kotlin_functions.php">Kotlin Functions</a>
<br>

<h2>Kotlin Classes</h2>
<a target="_top" href="kotlin_oop.php">Kotlin OOP</a>
<a target="_top" href="kotlin_classes.php">Kotlin Classes/Objects</a>
<a target="_top" href="kotlin_constructors.php">Kotlin Constructors</a>
<a target="_top" href="kotlin_class_functions.php">Kotlin Class Functions</a>
<a target="_top" href="kotlin_inheritance.php">Kotlin Inheritance</a>
<br>

<h2>Kotlin Examples</h2>
<a target="_top" href="kotlin_examples.php">Kotlin Examples</a>
<a target="_top" href="kotlin_exercises.php">Kotlin Exercises</a>
<a target="_top" href="kotlin_compiler.php">Kotlin Compiler</a>
      <br><br>
    </div>
  </div>
</div>
...
<h1>Kotlin <span class="color_h1">Tutorial</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="/default.asp">&#10094; Home</a>
  <a class="w3-right w3-btn" href="kotlin_intro.php">Next &#10095;</a>
</div>
<hr>

<div class="w3-panel w3-info intro">
<h2>Learn Kotlin</h2>
<p>Kotlin is a modern, trending programming language.</p>
  <p>Kotlin is easy to learn, especially if you already know Java (it is 
  100% compatible with Java).</p>
<p>Kotlin is used to develop Android apps, server side apps, and much more.</p>
<a class="ws-btn" href="kotlin_intro.php" style="font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">Start learning Kotlin now &raquo;</a>
</div>
<hr>

<h2>Examples in Each Chapter</h2>
<p>Our &quot;Try it Yourself&quot; editor makes it easy to learn Kotlin. You can edit the 
code and view the result in your browser:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh" style="border-left:5px solid #04AA6D">
  fun main() { <br>&nbsp; println(&quot;Hello World&quot;) <br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_helloworld">Try it Yourself &raquo;</a>
</div>

<p><b>Click on the &quot;Try it Yourself&quot; button to see how it works.</b></p>
<div class="w3-panel w3-note" style="background-color:#FFF4A3">
<p>We recommend reading this tutorial, in the sequence listed in the left menu.</p>
</div>
<hr>

<h2>Kotlin Exercises</h2>
<form autocomplete="off" id="w3-exerciseform" action="exercise.php?filename=exercise_syntax1" method="post" target="_blank">
...
<pre>
<input name="ex1" maxlength="3" style="width: 40px;"> <input name="ex2" maxlength="4" style="width: 44px;">() {
  println("Hello World")
}
</pre>
</div>
...
<p><a target="_blank" href="exercise.php?filename=exercise_syntax1">Start the Exercise</a></p>
</div>
</form>
...
<p><a href="kotlin_examples.php" class="w3-button ws-grey w3-round" style="font-size: 17px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">See All Kotlin Examples</a></p>
<hr>

<h2>Download Kotlin</h2>
<p>Download Kotlin from github:
<a target="_blank" href="https://github.com/JetBrains/kotlin">https://github.com/JetBrains/kotlin</a></p>
<hr>
<br>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn w3-round w3-white" href="/default.asp" style="font-family: 'Roboto Mono', monospace;baxckground-color:#F3ECEA;colxor:black;border:1px solid #E7E9EB;padding:20px 60px 20px 20px;text-align:left"><span style="color:#999">&#10094; Home</span><br class="w3-hide-small"> <span class="w3-hide-small">w3schools.com</span></a>
<a class="w3-right w3-btn w3-round" href="kotlin_intro.php" style="font-family: 'Roboto Mono', monospace;background-color:#04AA6D;padding:20px;text-align:right"><span style="color:#D9EEE1">Next &#10095;</span><br class="w3-hide-small"><span class="w3-hide-small"> Kotlin Introduction</span></a>
</div>
...
<img src="/images/colorpicker.gif" alt="colorpicker" loading="lazy"></a>
</div>
...
<script src="/lib/w3schools_footer.js?update=20210824"></script>
