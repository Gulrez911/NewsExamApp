...
<body>
	...
	<div id="page">
		...
		<div class="container">
			<input class="form-control" id="myInput" type="text" placeholder="Search.."> <a href="createCategory"><button
					type="button" class="btn btn-primary">Create Category</button></a> <a href="createExam"><button type="button"
					class="btn btn-primary">Create Exam</button></a> <a href="listExam"><button type="button" class="btn btn-primary">List
					Exam</button></a> <a href="listCategory"><button type="button" class="btn btn-primary">List Category</button></a>
				...
				<tbody>
					<c:forEach items="${categories}" var="category" varStatus="loop">
						<tr>
							...
							<td><c:forEach items="${category.exams}" var="exam" varStatus="loop2">
							
							${exam.examName},
							&nbsp&nbsp
							</c:forEach></td>

							<td><a href="createCategory?cid=${category.id}"><button type="button" class="btn btn-primary">Update</button></a></td>

							<td><a href="deleteCategory?cid=${category.id}"><button type="button" class="btn btn-primary">Delete</button></a></td>
							<%-- 						<td>${loop.index}</td> --%>
							<!-- 						<td>@mdo</td> -->
						</tr>
					</c:forEach>
