...
@Service
public class NewsSchedulerService2 {
...
//	@Scheduled(cron = "0 */5 * * * *") // per 5 min
	public void performTaskUsingCronTotal2() throws Exception {
...
//	@Scheduled(cron = "0 */1 * * * *") // per 5 min
	public void performTaskUsingCronTotal() throws Exception {
...
//			map.put("news", newsList);
		...
		File file2 = ResourceUtils.getFile("classpath:NewsNdtvHi.xlsx");
		InputStream stream2 = FileUtils.openInputStream(file2);
		File f2 = ResourceUtils.getFile("classpath:NewsDtoNdtvHi.xml");
		System.out.println("processing excel file " + f2.getName());
		List<NewsDtoExcel> records2 = ExcelReader.parseExcelFileToBeans(stream2, f);
		for (NewsDtoExcel excel : records2) {
...
//		File file4 = ResourceUtils.getFile("classpath:NewsJansatta.xlsx");
//		InputStream stream4 = FileUtils.openInputStream(file4);
//		File f4 = ResourceUtils.getFile("classpath:NewsDtoJansatta.xml");
//		System.out.println("processing excel file " + f4.getName());
//		List<NewsDtoExcel> records4 = ExcelReader.parseExcelFileToBeans(stream4, f4);
//		for (NewsDtoExcel excel : records4) {
//
//			System.out.println(excel.toString());
//
//			List<News> newsList = new ArrayList<>();
...
//		File file5 = ResourceUtils.getFile("classpath:NewsIndianExpress.xlsx");
//		InputStream stream5 = FileUtils.openInputStream(file5);
//		File f5 = ResourceUtils.getFile("classpath:NewsDtoIndianExpress.xml");
//		System.out.println("processing excel file " + f5.getName());
//		List<NewsDtoExcel> records5 = ExcelReader.parseExcelFileToBeans(stream5, f5);
//		for (NewsDtoExcel excel : records5) {
//
//			System.out.println(excel.toString());
//
//			List<News> newsList = new ArrayList<>();
...
//			map.put("news", newsList);
		...
		File file9 = ResourceUtils.getFile("classpath:tv9hindi.xlsx");
		InputStream stream9 = FileUtils.openInputStream(file9);
		File f9 = ResourceUtils.getFile("classpath:NewsDtotv9hindi.xml");
		System.out.println("processing excel file " + f9.getName());
		List<NewsDtoExcel> records9 = ExcelReader.parseExcelFileToBeans(stream9, f9);
		for (NewsDtoExcel excel : records9) {
...
//		File file10 = ResourceUtils.getFile("classpath:NewsBhaskar.xlsx");
//		InputStream stream10 = FileUtils.openInputStream(file10);
//		File f10 = ResourceUtils.getFile("classpath:NewsDtoBhaskar.xml");
//		System.out.println("processing excel file " + f10.getName());
//		List<NewsDtoExcel> records10 = ExcelReader.parseExcelFileToBeans(stream10, f10);
//		for (NewsDtoExcel excel : records10) {
//
//			System.out.println(excel.toString());
//
//			List<News> newsList = new ArrayList<>();
							...
							if (ww.className().contains("bbc-19j92fr ebmt73l0")) {
								...
								for (Element cd : sss) {
									if (cd.className().contains("bbc-kl1u1v e17g058b0")
											...
											&& !cd.toString().contains("ये भी पढ़ें")) {
